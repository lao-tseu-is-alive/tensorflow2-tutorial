-- RETRIEVE DOCUMENTS FROM FAMILY 'CORRESPONDANCE' [7] INDEXED BY 'ATELIER NUM GOELAND'
SELECT E.IdType,
...
AND D.IdDocFamily = 7
GROUP BY E.IdType,IdDocFamily,D.LocFileExt
ORDER BY 1 DESC;
/*
    11'528	7	Correspondance	txt
     8'545	7	Correspondance	pdf
         8	7	Correspondance	docx
         1	7	Correspondance	doc
*/

-- retrieve 1200 pdf documents from family 7 'Correspondance' (run the output on a temp dir on golux)
SELECT TOP 1200
