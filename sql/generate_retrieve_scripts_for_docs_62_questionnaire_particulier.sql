/*
 RETRIEVE DOCUMENTS FROM FAMILY 'Questionnaire particulier' [62] INDEXED BY 'ATELIER NUM GOELAND'
*/
SELECT --E.IdType,
...
AND D.IdDocFamily in (62)
GROUP BY --E.IdType,
         IdDocFamily,D.LocFileExt
ORDER BY 1 DESC;
/* as of 2021-02-04
   1466 62  Questionnaire particulier   pdf
*/
